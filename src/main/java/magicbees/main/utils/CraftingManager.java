...
public class CraftingManager {
    ...
    private static void setupVanillaCrafting() {
        ...
        output.stackSize = 4;
        GameRegistry.addRecipe(new ShapedOreRecipe(output, "WWW", 'W', "waxMagical"));
        ...
        GameRegistry.addRecipe(output, " S ", " F ", " S ", 'F', input, 'S', Blocks.sand);
        GameRegistry.addRecipe(output, "   ", "SFS", "   ", 'F', input, 'S', Blocks.sand);

        output = output.copy();
        output.stackSize = 12;
        GameRegistry.addRecipe(output, "aaa", "aFa", "aaa", 'F', input, 'a', ItemInterface.getItemStack("ash"));
        ...
        GameRegistry.addRecipe(
                ...
                "DDD",
                'D',
                Config.drops.getStackForType(DropType.INTELLECT),
                'B',
                Items.glass_bottle);

        GameRegistry.addRecipe(
                new ItemStack(Blocks.soul_sand, 4),
                "SwS",
                "wDw",
                "SwS",
                'S',
                ...
                Blocks.dirt,
                'w',
                Config.wax.getStackForType(WaxType.SOUL));
        GameRegistry.addRecipe(
                new ItemStack(Blocks.soul_sand, 4),
                "wSw",
                "SDS",
        ...
        GameRegistry.addRecipe(output, "www", "wfw", "www", 'w', Config.wax.getStackForType(WaxType.MAGIC), 'f', input);

        GameRegistry.addRecipe(
                new ItemStack(Config.hiveFrameTemporal),
                "sPs",
                "PfP",
                "sPs",
                's',
        ...
        GameRegistry.addRecipe(
                ...
                "xxx",
                'x',
                Config.miscResources.getStackForType(ResourceType.SKULL_CHIP));
        ...
        GameRegistry.addRecipe(
                Config.miscResources.getStackForType(ResourceType.DRAGON_CHUNK),
                "xxx",
                "xxx",
                'x',
                Config.miscResources.getStackForType(ResourceType.DRAGON_DUST));
        ...
        GameRegistry.addShapelessRecipe(
                new ItemStack(Config.hiveFrameResilient),
                Config.miscResources.getStackForType(ResourceType.ESSENCE_EVERLASTING_DURABILITY),
                input);

        GameRegistry.addShapelessRecipe(
                new ItemStack(Config.hiveFrameGentle),
                Config.miscResources.getStackForType(ResourceType.ESSENCE_FALSE_LIFE),
                input);
        ...
        GameRegistry.addShapelessRecipe(
                new ItemStack(Config.hiveFrameMetabolic),
                Config.miscResources.getStackForType(ResourceType.ESSENCE_FICKLE_PERMANENCE),
                input);
        ...
        GameRegistry.addShapelessRecipe(
                new ItemStack(Config.hiveFrameOblivion),
                Config.miscResources.getStackForType(ResourceType.ESSENCE_SCORNFUL_OBLIVION),
        ...
        GameRegistry.addRecipe(
                new ItemStack(Config.enchantedEarth),
                "d d",
                " e ",
                "d d",
                'd',
        ...
        GameRegistry.addRecipe(
                new ShapedOreRecipe(new ItemStack(Items.iron_ingot), "xxx", "xxx", "xxx", 'x', "nuggetIron"));

        GameRegistry.addRecipe(
                new ShapedOreRecipe(new ItemStack(Items.diamond), "xxx", "xxx", "xxx", 'x', "nuggetDiamond"));
        ...
        if (ThaumcraftHelper.isActive()) {
            ...
            if (Config.thaumaturgeBackpackActive) {
                ...
                GameRegistry.addRecipe(
                        new ItemStack(Config.thaumaturgeBackpackT1),
                        "SWS",
                        "NCN",
                        "SWS",
                        'S',
                        ...
                        Blocks.wool,
                        'N',
                        new ItemStack(ThaumcraftHelper.miscResource, 1, ThaumcraftHelper.MiscResource.AMBER.ordinal()),
                        'C',
                        Blocks.chest);
            }
        }
    ...
    private static void setupCarpenterRecipes() {
        ...
        RecipeManagers.carpenterManager.addRecipe(
                ...
                " P ",
                'P',
                ItemInterface.getItemStack("pollen"),
                'J',
                ItemInterface.getItemStack("royalJelly"),
                'D',
