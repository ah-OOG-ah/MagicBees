...
public class ModelVisAuraProvider {
    ...
    public static final ResourceLocation objFile = new ResourceLocation(
            CommonProxy.DOMAIN,
            CommonProxy.MODEL + "visAuraConverter.obj");
    public static final ResourceLocation textureLocation = new ResourceLocation(
            CommonProxy.DOMAIN,
            CommonProxy.MODEL + "visAuraProvider.png");
    ...
    public void render(long tick) {
        ...
        GL11.glTranslated(
                Math.sin(tick * Math.PI * 2 / 1000) * 0.025,
                0,
                Math.sin((tick + 30) * Math.PI * 2 / 650) * 0.03);
