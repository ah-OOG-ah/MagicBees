...
/**
 * Class to control plugin logic for the Transmutation bee effect. Turns blocks into other blocks based on biome, time
 * of day, or whatever is deemed appropriate at the time.
 *
...
public interface ITransmutationEffectLogic {
    ...
    /**
     * Allows an external mod to add transmutation logic to the Transmuting bee effect. Called from a list of
     * ITransmutationEffectLogic until one returns true. You can implement more than one transmutation effect in a
     * single implementation of the interface. Function checks for a series of conditions based on block ID/meta, or
