...
public enum BeeSpecies {
    ...
    CHARMED(
            "Charmed",
            "larvatus",
            BeeClassification.SUPERNATURAL,
            0x48EEEC,
            BodyColours.ARCANE,
            EnumTemperature.NORMAL,
            EnumHumidity.NORMAL,
    ...
    SKULKING(
            "Skulking",
            "malevolens",
            BeeClassification.SKULKING,
            0x524827,
            BodyColours.SKULKING,
            EnumTemperature.NORMAL,
            EnumHumidity.NORMAL,
            false,
            true),
    ...
    INFERNAL(
            "Infernal",
            "infernales",
            BeeClassification.ABOMINABLE,
            0xFF1C1C,
            BodyColours.ABOMINABLE,
            EnumTemperature.HELLISH,
            EnumHumidity.ARID,
            false,
            true),
    ...
    OBLIVION(
            "Oblivion",
            "oblivioni",
            BeeClassification.EXTRINSIC,
            0xD5C3E5,
            BodyColours.EXTRINSIC,
    ...
    TC_AIR(
            "TCAir",
            "aether",
            BeeClassification.THAUMIC,
            0xD9D636,
            BodyColours.THAUMCRAFT_SHARD,
            EnumTemperature.NORMAL,
            EnumHumidity.NORMAL,
            true,
            true),
    ...
    AM_ESSENCE(
            "AMEssence",
            "essentia",
            BeeClassification.ESSENTIAL,
            0x86BBC5,
            BodyColours.ARSMAGICA,
            EnumTemperature.NORMAL,
            EnumHumidity.NORMAL,
            false,
            true),
    ...
    public boolean canWorkInTemperature(EnumTemperature temp) {
        IAlleleTolerance tolerance =
                (IAlleleTolerance) genomeTemplate[EnumBeeChromosome.TEMPERATURE_TOLERANCE.ordinal()];
        return AlleleManager.climateHelper.isWithinLimits(
                temp, EnumHumidity.NORMAL, temperature, tolerance.getValue(), EnumHumidity.NORMAL, EnumTolerance.NONE);
    }
